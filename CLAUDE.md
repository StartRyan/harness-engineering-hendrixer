...
- **LLM provider:** Aixcoder Anthropic-compatible relay via the Vercel AI SDK (default model `claude-opus-5`).
...
harness/        the runtime — accretes one module per lesson
  ...
  model.ts      the AI SDK Anthropic-compatible model (claude-opus-5 default)
